package com.plcoding.cleanarchitecturenoteapp.feature_note.presentation.notes.NotesViewModels
    ...
    fun onEvent(event : NotesEvent){
        when(event){
            ...
            is NotesEvent.ToggleOrderSection ->{
                _state.value.isOrderSectionVisible = !state.value.isOrderSectionVisible
            }
        }
    }
